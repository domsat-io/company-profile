...
const Project = () => {
  ...
  const data_projects = [
    { img: project1, title: 'Product Design', description: 'Developing the look and feel of physical products, aesthetics, and functionality.' },
    { img: project2, title: 'Logo and Branding', description: 'Creating or refreshing a company\'s logo and developing a cohesive visual identity.' },
    { img: project3, title: 'App UI/UX Design', description: 'Designing the UI/UXe for mobile apps and web applications to ensure usability & engagement.' },
    { img: project4, title: 'Packaging Design', description: 'Creating packaging solutions for products that not only protect attract customers on store.' },
    { img: project1, title: 'Product Design', description: 'Developing the look and feel of physical products, aesthetics, and functionality.' },
    { img: project2, title: 'Logo and Branding', description: 'Creating or refreshing a company\'s logo and developing a cohesive visual identity.' },
  ]
  return (
          ...
          {data_projects.map((project, index) => (
            <SwiperSlide key={index}>
              <div className="aximo-project-thumb">
                <Image src={project.img} alt={project.img} className="w-full h-[80px]" />
