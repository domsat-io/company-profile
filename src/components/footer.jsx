        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="aximo-default-content light position-relative">
              ...
              <Image src={shape1} alt="" className="w-[284px] h-[153px]" />
              </div>
            </div>
          </div>
          <div class="col-lg-5">
            <div class="aximo-form-wrap">
              ...
              <form action="#">
                ...
                <button id="aximo-submit-btn" type="submit">Send message <span><Image src={arrowRight3} alt="" className="w-[50px] h-[50px]" /></span></button>
              </form>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="aximo-footer-logo">
              <a href="">
              <Image src={logoWhite} alt="" className="w-[121px] h-[24px]" />
              </a>
            </div>
          </div>
          <div class="col-lg-6">
