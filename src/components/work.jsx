        ...
        <div className="col-lg-4">
          <div className="aximo-counter-wrap">
            <div className="aximo-counter-data">
              <h2 className="aximo-counter-number"><span data-percentage="15" className="aximo-counter"></span>+</h2>
              <p>Years of experience</p>
            </div>
            <div className="aximo-counter-data">
              <h2 className="aximo-counter-number"><span data-percentage="120" className="aximo-counter"></span>k</h2>
              <p>Successful projects</p>
            </div>
            <div className="aximo-counter-data">
              <h2 className="aximo-counter-number"><span data-percentage="100" className="aximo-counter"></span>%</h2>
